...
**Ответ:**
***Мониторинг загрузки CPU (утилизация в %, LA), RAM (свободная память в Mb), Disk free size (системное пространство в Gb). Данный вид метрик влияют на загруженность сервера.***
#
